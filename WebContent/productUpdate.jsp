...
<div class="container">
	<div class="col-sm-12 col-md-10 col-lg-8 mx-auto">
		<div class="jumbotron" style="padding-top: 20px;">
			<form method="post" action="productUpdateAction.jsp?pID=<%= pID %>">
				<h3 style="text-align: center;">상품 등록</h3>
				<div class="form-group">
					<input type="text" class="form-control" readonly placeholder="<%=product.getuName() %>" name="uName" maxlength="20">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<input type="text" class="form-control" placeholder="상품명" name="pName" maxlength="20" value="<%=product.getpName() %>">
				</div>
				<div class="form-group">
					입찰가&nbsp;<input type="number" name="bid" maxlength="10" placeholder="0" value="<%=product.getBid()%>" step="100"> 원
					&nbsp;&nbsp;&nbsp;
					<input type="number" placeholder="즉시 판매가" name="price" maxlength="10" value="<%=product.getPrice()%>" step="100"> 원
				</div>
				<div class="form-group">
					<label>경매 마감일</label>
				...
				<div class="form-group">
					<%-- <input type="image" name="image" size="20" class="form-control" value="<%=product.getImage()%>"> --%>
					<input type="file" name="image" size="20" class="form-control">
				</div>
				<div class="form-group">
					<textarea class="form-control" placeholder="상품 설명" name="description" maxlength="2048" style="height: 200px;"><%=product.getDescription() %></textarea>
				</div>
